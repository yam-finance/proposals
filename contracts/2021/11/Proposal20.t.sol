...
contract Prop20 is YAMv3Test {
    ...
    function test_proposal_20() public {
        ...
        string memory description = "Contributors previous months comps, previous pay for 2 contributors and vesting pool streams updates";
        ...
        assertTrue(IERC20(yUSDC).balanceOf(address(reserves)) > 718397002304);
